...
for cluster_name, cluster in all_data['clusters'].items():

    print(f'Doing {cluster_name}')

    data = [x['data'] for x in cluster]
...
#    print(left, right, top, bot)
    ...
    idx = int(cluster_name)

    outname = f'rot.{nw:02}.{idx:02}..png'
